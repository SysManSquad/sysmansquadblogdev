...
![screenshot](msedge_OGHmAQhYGe-1024x448.png) Example of a proactive remediation graph in the Intune Portal 
...
![screenshot](msedge_Pm7pXyDNrT.png) 
  6. Select **Next**
  7. Select your assignment group 
  8. By default it will schedule to run daily, you can edit this to be Once, Hourly, or Daily![screenshot](msedge_dZOZmuqnCB.png)
  9. Select **Next**
...
![screenshot](msedge_UJCXFijoRN.png) 
  5. Check the respective field for where the error occurred and you should be able to diagnose why the failure happened

### Other issues?

If you run into any other issues or have questions about anything Intune head over to the [WinAdmins discord community](https://aka.ms/winadmins) and go to the #Intune channel.
