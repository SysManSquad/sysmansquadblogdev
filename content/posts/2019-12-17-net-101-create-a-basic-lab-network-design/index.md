...
IPv4:
For our purposes, the DHCPv4 range will be 10.248.100.[50-99]/24 as we do not expect to have a large number of DHCP clients. We will use **10.248.100.3/24** for our DHCPv4 server address.
...
Hey, so now we have an idea of our network definition. We know what it is, what the addresses of the critical services are, and what we're going to call it. This is an excellent time to write it down.

|Item|Value|
|---|---|
| Subnet ID	| 10.248.100.0/24 |
|           | fdda:f6d4:f5a2:f1e6::/64 |
| Default Gateway | 10.248.100.1/24 |
|                 | fdda:f6d4:f5a2:f1e6::1/64 |
| DNS Server | 10.248.100.2/24 |
|            | fdda:f6d4:f5a2:f1e6::2/64 |
| DNS Domain | lab.test. |
| DHCP Server Address | 10.248.100.3/24 |
|                     | fdda:f6d4:f5a2:f1e6::3/64 |
| DHCP Range | 10.248.100.[50-99]/24 |
|            | fdda:f6d4:f5a2:f1e6::[32-63]/64 |
| VLAN ID | 77 |

Well that was simple. But also maybe we should do this in a visual way as well. Being able to visualize your network can help you find problems later. Even though our network is basic, let's document it as well as we can.

![Lab-Network-3.png](Lab-Network-3.png)

**[Here are the source files for this drawing.](https://github.com/SysManSquad/BlogFiles/tree/master/aaron/net-101)**
